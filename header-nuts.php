...
<html <?php language_attributes(); ?>>
	...
	<body>
        ...
        <![endif]-->	
        <div class="ournuts-wrapper" style="background: url(<?php echo get_the_post_thumbnail_url(); ?>);">
	        <!-- header part start -->		
			<div class="contact-header">
				...
				<div class="ournuts-top-arrow">
					<a href="#" class="text-center"><i class="fas fa-angle-down"></i></a>
				</div>					
			</div>	
		</div>	
		<!-- header part end -->